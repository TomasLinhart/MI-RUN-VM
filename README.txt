...
Maven projekt:
 ...
 - spuštění VM: mvn clean compile exec:java -Dexec.args="1024 64 512 Main.xml"
...
- iload = vloží na zásobník hodnotu lokálního proměnné (int)
- pload = vloží na zásobník hodnotu lokálního proměnné (pointer)
